 ...
 * @author User
 */
public class CounselAdd extends javax.swing.JFrame {
    private static int id;
    
    /**
     * Creates new form CounselAdd
     */
    public CounselAdd(int idUser) {
        initComponents();
        this.id = idUser;
    }
    ...
    private void initComponents() {
        ...
        inputProblem = new javax.swing.JTextArea();
        ...
        inputProblem.setBackground(new java.awt.Color(0, 119, 182));
        inputProblem.setColumns(20);
        inputProblem.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        inputProblem.setForeground(new java.awt.Color(255, 255, 255));
        inputProblem.setRows(5);
        inputProblem.setCaretColor(new java.awt.Color(255, 255, 255));
        jScrollPane1.setViewportView(inputProblem);
        ...
        buttonSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/healy/asset/buttonSend.png"))); // NOI18N
    ...
    private void buttonSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonSaveMouseClicked
        ...
        String entry = inputProblem.getText();
        Counsel counsel = new Counsel();
        int result = counsel.insert(title, entry, id);
        if(result == 1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CounselAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CounselAdd(id).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextArea inputProblem;
